<template>
    <div class="Discover-feature-wrapper">
          ...
          <div class="card-content">
            ...
            <div class="activities-section">
                ...
                <div class="activities-list">
                    ...
                    <div>dsldksldks;odkspodkspokdspokdokdposd;ls;ld;lhsjldfbaflhlsdfbsdlbaldfhsbflsdhbaslfdskjfsalkdfjbslfshabfhbsalfshabsahbhasbsahfabslhfabslhb,</div>
                </div>
            </div>
          </div>
        </div>
